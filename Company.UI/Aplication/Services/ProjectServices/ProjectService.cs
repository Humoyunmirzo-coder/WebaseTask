...
namespace Aplication.Servises
{
    ...
    public class ProjectService : IProjectService
    {
        ...
        public async Task ProjectCreateExcelFileAsync(List<ProjectGetDto> persons)
        {
            ...
            using (var package = new ExcelPackage())
            {
                ...
                worksheet.Cells[1, 2].Value = "ImportanceLevelId";
                worksheet.Cells[1, 3].Value = "Organizationid";
                worksheet.Cells[1, 4].Value = "ProjectLevelId";

                // Ma'lumotlarni yozish
                for (int i = 0; i < persons.Count; i++)
                {
                    worksheet.Cells[i + 2, 1].Value = persons[i].Id;
                    worksheet.Cells[i + 2, 2].Value = persons[i].ImportanceLevelId;
                    worksheet.Cells[i + 2, 3].Value = persons[i].Organizationid;
                    worksheet.Cells[i + 2, 4].Value = persons[i].ProjectLevelId;
                }
